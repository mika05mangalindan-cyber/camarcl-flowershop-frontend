  ...
  return (
    <div className="bg-white border rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-200 flex flex-col gap-3">
      ...
      <div className="flex justify-between items-center">
        <h3 className="font-semibold text-gray-800">{order.user_name}</h3>
        ...
        {order.items.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-gray-700 text-sm">Qty: {item.quantity}</span>
            </div>
      ...
      <div className="flex justify-between items-center mt-2 flex-wrap gap-2">
        ...
        <span className="text-gray-700 font-semibold">Payment: {order.payment_mode}</span>
        <span
          className={`font-semibold px-2 py-1 rounded inline-block ${getStatusClasses(
            order.status
          )}`}
        >
          {order.status}
